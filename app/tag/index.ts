 ...
 * @returns {*|SemVer}
 */
export function parse(rawVersion: string): SemVer | null {
 ...
 * @returns {*|string|null}
 */
export function diff(version1: string, version2: string): semver.ReleaseType | null {
    const version1Semver = parse(version1);
    const version2Semver = parse(version2);
 ...
 * @return {*}
 */
export function transform(transformFormula: string | undefined, originalTag: string): string {
