...
test('reload should keep previous config when config file contains invalid JSON', () => {
    fsExistsSyncMock.mockReturnValue(true);
    fsReadFileSyncMock
        .mockReturnValueOnce('{"log": {"level": "debug"}}')
...
test('reload should apply new config after invalid JSON is fixed', () => {
    fsExistsSyncMock.mockReturnValue(true);
    fsReadFileSyncMock
        .mockReturnValueOnce('{"log": {"level": "debug"}}')
        .mockReturnValueOnce('{"log":')
        .mockReturnValueOnce('{"log": {"level": "info"}}');
